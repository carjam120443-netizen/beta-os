...
KERNEL_OBJECTS := $(BUILD)/boot.o $(BUILD)/kernel.o $(BUILD)/mem.o $(BUILD)/fs.o $(BUILD)/net.o $(BUILD)/exec.o $(BUILD)/shell.o
...
$(BUILD)/boot.o: boot/boot.asm | $(BUILD)
	nasm -f elf64 $< -o $@
$(BUILD)/kernel.o: kernel/kernel.c kernel/fs.h kernel/net.h kernel/exec.h kernel/shell.h kernel/mem.h | $(BUILD)
	gcc $(CFLAGS) -c $< -o $@
$(BUILD)/mem.o: kernel/mem.c kernel/mem.h | $(BUILD)
	gcc $(CFLAGS) -c $< -o $@
...
$(BUILD)/exec.o: kernel/exec.c kernel/exec.h | $(BUILD)
	gcc $(CFLAGS) -c $< -o $@
$(BUILD)/shell.o: kernel/shell.c kernel/shell.h kernel/fs.h kernel/net.h kernel/exec.h kernel/mem.h | $(BUILD)
	gcc $(CFLAGS) -c $< -o $@
